...
<div class="container">
	<div class="row d-flex justify-content-center">
		<h1 class="h1OrderList">Order List</h1>
...
{       
    NumberFormat currFormat = NumberFormat.getCurrencyInstance();
    ResultSet rst = stmt.executeQuery("SELECT os.orderId, os.orderDate, os.customerId, (SELECT c.firstName from customer c where customerId = os.customerId), (SELECT c.lastName from customer c where customerId = os.customerId), totalAmount FROM ordersummary os");     
...
<div class="backToMain">
	<a href="shop.html"><button type="button" class="btn btn-danger">Back to Main Page</button></a>
</div>
</div>
</div>
</body>
